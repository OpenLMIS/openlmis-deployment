...
--Start additional tables

create table public.kafka_contract_equipments
(
    contractid  uuid not null,
    equipmentid uuid not null
);

alter table public.kafka_contract_equipments owner to postgres;


create table public.kafka_contract_facilities
(
    contractid uuid not null,
    facilityid uuid not null
);

alter table public.kafka_contract_facilities
    owner to postgres;


create table public.kafka_contract_service_types
(
    contractid uuid not null,
    servicetypeid uuid not null
);

alter table public.kafka_contract_service_types owner to postgres;

create table public.kafka_contracts
(
    id uuid not null,
    modifieddate timestamp with time zone,
    createddate timestamp with time zone,
...
alter table public.kafka_contracts owner to postgres;

create table public.kafka_equipment_catalog_items
(
    id uuid not null,
...
alter table public.kafka_equipment_catalog_items owner to postgres;

create table public.kafka_equipment_categories
(
    id uuid not null,
    code text not null,
    name text,
...
alter table public.kafka_equipment_categories owner to postgres;

create table public.kafka_equipment_disciplines
(
    id uuid not null,
    name text not null,
    code text not null,
...
alter table public.kafka_equipment_disciplines owner to postgres;

create table public.kafka_equipment_energy_types
(
    id uuid not null,
    code text not null,
    name text not null,
...
alter table public.kafka_equipment_energy_types owner to postgres;

create table public.kafka_equipment_fund_sources
(
    id uuid not null,
    code text not null,
    name text not null,
...
alter table public.kafka_equipment_fund_sources owner to postgres;

create table public.kafka_equipment_inventory
(
    id uuid not null,
    equipmentid uuid not null,
    facilityid uuid not null,
    ...
    decommissiondate timestamp with time zone,
    modifieddate timestamp with time zone,
    createddate timestamp with time zone,
    equipmenttrackingid text not null,
    source text,
    dateofinstallation timestamp with time zone not null,
    dateofwarrantyexpiry timestamp with time zone,
    purchaseprice double precision,
    registrationstatus text not null,
    fundsourceid uuid
);

alter table public.kafka_equipment_inventory owner to postgres;


create table public.kafka_equipment_inventory_items
(
    id uuid not null,
    facilityid uuid not null,
...
alter table public.kafka_equipment_inventory_items owner to postgres;

create table public.kafka_equipment_maintenance_request_reasons
(
    id uuid not null,
    code text not null,
    name text not null
...
alter table public.kafka_equipment_maintenance_request_reasons owner to postgres;

create table public.kafka_equipment_maintenance_requests
(
    id uuid not null,
...
alter table public.kafka_equipment_maintenance_requests owner to postgres;

create table public.kafka_equipment_models
(
    id uuid not null,
    code text not null,
    name text not null,
...
alter table public.kafka_equipment_models owner to postgres;


create table public.kafka_equipment_operation_modes
(
    id uuid not null,
    name text not null,
    code text not null,
...
alter table public.kafka_equipment_operation_modes owner to postgres;

create table public.kafka_equipment_orderables
(
    id uuid not null,
    equipmentid uuid not null,
    orderableid uuid not null
...
alter table public.kafka_equipment_orderables owner to postgres;


create table public.kafka_equipment_service_logs
(
    id uuid not null,
...
alter table public.kafka_equipment_service_logs owner to postgres;

create table public.kafka_equipment_test_types
(
    id uuid not null,
    code text not null,
    name text not null,
...
alter table public.kafka_equipment_test_types owner to postgres;

create table public.kafka_equipment_type_programs
(
    id uuid not null,
    equipmenttypeid uuid not null,
    programid uuid not null,
...
alter table public.kafka_equipment_type_programs owner to postgres;

create table public.kafka_equipment_types
(
    id uuid not null,
    code text not null,
    name text not null,
...
alter table public.kafka_equipment_types owner to postgres;

create table public.kafka_equipments
(
    id uuid not null,
    name text not null,
    manufacturer text not null,
...
alter table public.kafka_equipments owner to postgres;

create table public.kafka_reasons_not_functional
(
    id uuid not null,
    name text not null,
    displayorder integer not null,
...
alter table public.kafka_reasons_not_functional owner to postgres;

create table public.kafka_service_types
(
    id uuid not null,
    name text not null,
    description text not null
...
alter table public.kafka_service_types owner to postgres;

create table public.kafka_vendor
(
    id uuid not null,
    modifieddate timestamp with time zone,
    createddate timestamp with time zone,
...
alter table public.kafka_vendor owner to postgres;

create table public.kafka_vendor_associated_users
(
    vendorid uuid not null,
    associateduser uuid not null
);

alter table public.kafka_vendor_associated_users owner to postgres;


--end additional tables
