...
app = Flask(__name__)
app.config['APPLICATION_ROOT'] = '/superset'
...
def lookup_password(url):
    return os.environ['SUPERSET_POSTGRES_PASSWORD']


SQLALCHEMY_DATABASE_URI = 'postgresql+psycopg2://{}:{}@reporting-db:5432/open_lmis_reporting'.format(
    os.environ['POSTGRES_USER'],
    os.environ['SUPERSET_POSTGRES_PASSWORD'])
...
CORS_ALLOW_ORIGINS = ['https://training.tz.elmis-dev.org']
...
# Set Superset’s root path to /superset
APPLICATION_ROOT = "/superset"

# Ensure Superset generates URLs correctly
PREFERRED_URL_SCHEME = "https"

# Redirect URLs to /superset/
WEBDRIVER_BASEURL = "https://training.tz.elmis-dev.org/superset"

# Set the preferred prefix for static files
